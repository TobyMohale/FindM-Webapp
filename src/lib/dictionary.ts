export const DICTIONARY = {
  ...
  af: {
    ...
    medicalInfo: 'Mediese inligting', allergies: 'Allergieë', conditions: 'Toestande', notes: 'Inligting',
  ...
  zu: {
    ...
    medicalInfo: 'Ulwazi lwezempilo', allergies: 'Uzwayo (Allergies)', conditions: 'Izimo zezempilo', notes: 'Ulwazi',
  ...
  nso: {
    ...
    medicalInfo: 'Tsebišo ya kalafo', allergies: 'Dilo tšeo a sa di kwanego (Allergies)', conditions: 'Maemo a maphelo', notes: 'Tsebišo',
